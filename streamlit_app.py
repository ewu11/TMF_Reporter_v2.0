...
def process_messages_from_file(file_contents):
    ...
    issue_patterns = {
        ...
        "Update Customer IC": r"\bic no.*invalid\b|\bicbrn invalid\b|\binvalid ic\/br\b|\bicbr invalid\b|\bv2p failed\b",
