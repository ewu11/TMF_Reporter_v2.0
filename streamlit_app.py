...
def process_messages_from_file(file_contents):
    ...
    issue_patterns = {
        ...
        "Add Resource Building/ SkillSet": r"(tak|x) k(e)?lua(r)? n(a)?k (book appt|reapp(t)?|ra)",
